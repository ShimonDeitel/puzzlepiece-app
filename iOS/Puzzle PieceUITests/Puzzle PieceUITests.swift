...
final class Puzzle PieceUITests: XCTestCase {
    ...
    func testAddItemFlow() throws {
        ...
        field.tap()
        field.typeText("Test Puzzle")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["Test Puzzle"].waitForExistence(timeout: 2))
    }
...
private let Store_freeLimitForUITests = 25
